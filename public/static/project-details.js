let arr = [
    ...
    {title: 'Yelp Camp', projLink: 'https://dry-depths-69632.herokuapp.com/' , gitLink: 'https://github.com/yoyoyachu/yelpCamp' , imgId: 'project-img-yelp' , description: "A full stack yelp like website using server side JS(Node.js), Express and mongoDB. A user should first register or log in to the website to add campgrounds or to add comments on others posts. Users can view all the campgrounds, comments and ratings but they're not authorized to change others posts."},
